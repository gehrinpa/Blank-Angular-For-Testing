...
@Component({
    selector: 'app-workforce-plan-edit',
    templateUrl: './workforce-plan-edit.component.html',
    styleUrls: ['./workforce-plan-edit.component.scss']
})
export class WorkforcePlanEditComponent implements OnInit {
    ...
    private parseSheet(data: any[][]) {
        ...
        const colMap = {
            ...
            'Current Headcount': {key: 'currentHeadcount', type: 'd'},
            // TODO: years
            'YE 2019': {key: 'year1Headcount', type: 'd'},
            'YE 2020': {key: 'year2Headcount', type: 'd'},
            'YE 2021': {key: 'year3Headcount', type: 'd'},
            'Net Change (2019-2021)': null,
            'Forecast Attrition': {key: 'forecastAttrition', type: 'd'},
            'Total Hiring Demand (Change + Attrition)': null,

            'Internal': {key: 'internal', type: 'd'},
            'Apprentice': {key: 'apprentice', type: 'd'},
            'Graduate': {key: 'graduate', type: 'd'},
            'Experienced': {key: 'experienced', type: 'd'},
            'Contract': {key: 'contract', type: 'd'},
        };
        ...
        for (const row of data) {
            ...
            if (!role && !row[0]) {
                role = {
                    ...
                    currentHeadcount: 0.0,
                    year1Headcount: 0.0,
                    year2Headcount: 0.0,
                    year3Headcount: 0.0,
                    forecastAttrition: 0.0,
